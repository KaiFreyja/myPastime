...
class SkillController extends Controller
{
    ...
    public function getOneSkill(Request $request,$id)
    {
		try {
	 ...
	 * @return Response
	 */
	public function putSkill(Request $request,$id){
		$api_name = $this->getApiName($request->path());
$this->validate($request, [
    'code' => 'integer',
    'name' => 'max:32',
	...
	public function deleteSkill(Request $request,$id){
		...
		try {
			...
			$model = new Skill ; 
			$pky = $model->primaryKey ;
			$query = Skill::where($pky , $id)->delete();
